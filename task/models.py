...
class CaseResult(models.Model):  #测试用例得分
    ...
    caseconfig = models.CharField( blank=True, null=True)  # 执行用例的命令
...
# class DimTool(models.Model): #维度
#     id = models.IntegerField(primary_key=True)
#     dimid = models.IntegerField(db_column='dimId', blank=True, null=True)  # Field name made lowercase.
#     toolid = models.IntegerField(db_column='toolId', blank=True, null=True)  # Field name made lowercase.
#
#     class Meta:
#         managed = False
#         db_table = 'dim_tool'
...
# class Sharetask(models.Model): #任务共享表
...
class Task(models.Model): #测试任务
    owner = models.ForeignKey(User) #拥有者
    ...
    shareusers = models.ManyToManyField(User,db_column='shareTask') #共享表和用户的多对多关系
    class Meta:
        managed = False
        db_table = 'task'
...
class TestResult(models.Model):
    case = models.IntegerField(db_column='caseId', blank=True, null=True)  # 测试用例
    result = models.CharField(max_length=255, blank=True, null=True) # 测试得分
    taskid = models.IntegerField(db_column='taskId', blank=True, null=True)  # Field name made lowercase.
    unit = models.CharField(max_length=50, blank=True, null=True)
    firstresult = models.CharField(db_column='firstResult', max_length=50, blank=True, null=True)  # Field name made lowercase.
    caseconfig = models.CharField(db_column='caseConfig', max_length=255, blank=True, null=True)  # Field name made lowercase.
    dimensionresult = models.CharField(db_column='dimensionResult', max_length=255, blank=True, null=True)  # Field name made lowercase.
